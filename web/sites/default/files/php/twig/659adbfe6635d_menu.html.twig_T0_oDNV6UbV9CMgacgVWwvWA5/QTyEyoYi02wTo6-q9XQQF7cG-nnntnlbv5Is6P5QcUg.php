...
class __TwigTemplate_9525ae5b8519a5b5d32dde1d075fbd7d extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 33
                    echo "      <ul";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [["nav navbar-nav"]], "method", false, false, true, 33), 33, $this->source), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 35
    ...
    ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    echo "      ";
                    // line 39
                    $context["classes_link"] = ["nav-link", ((twig_get_attribute($this->env, $this->source,                     // line 41
$context["item"], "is_expanded", [], "any", false, false, true, 41)) ? ("dropdown-toggle") : ("")), ((twig_get_attribute($this->env, $this->source,                     // line 42
$context["item"], "is_collapsed", [], "any", false, false, true, 42)) ? ("dropdown-toggle") : ("")), ((twig_get_attribute($this->env, $this->source,                     // line 43
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) ? ("active") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/navigation/menu.html.twig", "/home/u998555632/domains/jorgesierra.dev/public_html/web/themes/contrib/bootstrap5/templates/navigation/menu.html.twig");
    }
