...
class __TwigTemplate_909045af5152d922e6f0ca0f8927f971 extends Template
{
    private $source;
    private $macros = [];
...
<article";
  ...
  ";
      ...
      <div";
            // line 94
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["author_attributes"] ?? null), "addClass", ["node__submitted"], "method", false, false, true, 94), 94, $this->source), "html", null, true);
            echo ">
        ";
            // line 95
  ...
  <div";
        // line 101
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", ["node__content"], "method", false, false, true, 101), 101, $this->source), "html", null, true);
        echo ">
    ";
        // line 102
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/content/node.html.twig", "/home/u998555632/domains/jorgesierra.dev/public_html/web/themes/contrib/bootstrap5/templates/content/node.html.twig");
    }
